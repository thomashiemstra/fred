...
class FindEllipseRadiiTests(unittest.TestCase):
    ...
    def test_same_y_1(self):
        ...
        a, b = linalg_utils.find_ellipse_radii(first_point, second_point, centre)
    ...
    def test_same_point(self):
        ...
        a, b = linalg_utils.find_ellipse_radii(first_point, first_point, centre)
...
class GetParametricParameterTests(unittest.TestCase):
    ...
    def test_circle(self):
        ...
        t = linalg_utils.get_parametric_parameter(a, b, 0, 0, x, y)
    ...
    def test_ellipse(self):
        ...
        t_actual = linalg_utils.get_parametric_parameter(a, b, x_c, y_c, x, y)
